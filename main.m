...
templates('waldo') = {rgb2gray(imread('waldo.png')), 'r'};
templates('wenda') = {rgb2gray(imread('wenda.png')), 'b'};
templates('wizard') = {rgb2gray(imread('wizard.png')), 'g'};
templates('odlaw') = {rgb2gray(imread('odlaw.png')), 'y'};

image = rgb2gray(imread('image.png'));
